...
class PredictionPipeline:
    ...
    def get_model_from_gcloud(self) -> str:
        ...
        try:
            ...
            # I commented the code beacause as of now i am not using gcloud from our local bucketName folder we load our model
            #self.gcloud.sync_folder_from_gcloud(self.bucket_name, self.model_name, self.model_path)
            #os.rmdir(self.model_path)
            if not os.path.exists(self.model_path):
                shutil.copytree(self.bucket_name,self.model_path)
