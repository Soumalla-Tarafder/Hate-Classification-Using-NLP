...
class DataIngestion:
    ...
    def get_data_from_gcloud(self) -> None:
        try:
            ...
            # As we dont using gcloud as of now i commented the below code -- 
    ...
    def unzip_and_clean(self):
        ...
        try: 
            ...
            # As we dont using gcloud as of now I commented the below code and giving a static path-- 

            # with ZipFile(self.data_ingestion_config.ZIP_FILE_PATH, 'r') as zip_ref:
            #     zip_ref.extractall(self.data_ingestion_config.ZIP_FILE_DIR)
            
            with ZipFile('data\dataset.zip', 'r') as zip_ref:
                 zip_ref.extractall(self.data_ingestion_config.ZIP_FILE_DIR)
