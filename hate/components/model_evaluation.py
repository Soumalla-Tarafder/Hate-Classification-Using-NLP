 ...
 data transformation artifact stage
    ...
    def get_best_model_from_gcloud(self) -> str:
        ...
        try:
            ...
            # close the part as we dont use thegcloud as of now
            ...
            if os.path.exists(os.path.join(self.model_evaluation_config.BUCKET_NAME,self.model_evaluation_config.MODEL_NAME)):
                shutil.copytree(self.model_evaluation_config.BUCKET_NAME, self.model_evaluation_config.BEST_MODEL_DIR_PATH)
